...
public class notepad extends javax.swing.JFrame {
        ...
        try {
            ...
            for(int i=0;i<ln;i+=4){System.out.println("count "+i);
                ...
                if(usr.equals(forUser) & pswd.equals(forPswd)){
                    JOptionPane.showMessageDialog(null, "Welcome "+forUser);
                    break;
                }else if(i==(ln-3)){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        readFile();
        countLines();
        logic(tfusr.getText(), tfpswd.getText());//login
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        tfusr.setText("");
        tfpswd.setText("");
        tfmail.setText("");// reset ,clear TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        readFile();
        countLines();
        addData("eva","eva", "eva299299@gmail.com");//test
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        readFile();
        countLines();
        addData(tfusr.getText(),tfpswd.getText(),tfmail.getText()); //register
